/**
 * PAGE COLLABORER — « Là où nos disciplines se croisent » (contenu interactif)
 * Route : /collaborer
 *
 ...
 *
 * Les metadata SEO vivent dans `page.tsx` (Server Component).
 */
...
export default function CollaborerClient() {
  return (
