...
const questions: Question[] = [
  ...
  },
  {
    ...
    weight: 2,
    options: [
      { label: '> 2,5 h/semaine (renfo + endurance)', points: 0 },
      { label: '> 1,5 h/semaine', points: 10 },
  ...
  },
  {
    ...
    options: [
      ...
      { label: '< 3 portions + protéines irrégulières + alimentation très transformée fréquente', points: 50 },
