...
export function SandboxInteractive() {
  ...
  return (
    <div className="bg-black min-h-screen md:h-screen flex flex-col overflow-hidden">
      ...
      {/* Header avec logo et titre - fixed en haut */}
      <div className="bg-gradient-to-r from-slate-950 via-black to-slate-950 border-b border-white/10 py-2 px-4 md:py-4 md:px-8 flex-shrink-0 sticky top-0 z-20">
      ...
      <div className="overflow-auto">
        <div className="min-w-max px-8 md:px-0">
          ...
          {/* Contrôles de simulation - collé directement sous les sliders */}
          <div className="bg-gradient-to-r from-slate-950 to-black border-t border-white/10 py-2 px-3 md:py-4 md:px-8 mt-2 mb-4">
