...
const AnimatedLogo: React.FC<AnimatedLogoProps> = ({ className = "", size = 300 }) => {
  const pathVariants = {
    hidden: {
      pathLength: 0,
      opacity: 0
    ...
    >
      ...
      >
        <g transform="translate(0, 300) scale(0.1, -0.1)">
          {/* Groupe entier - Animation d'une traite */}
          <motion.g
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.5 }}
          >
            {/* Premier path - Forme principale du logo */}
            <motion.path
