...
// Couleurs LeVerre Labs par défaut
const defaultColors = {
  background: 'bg-black',
  primary: 'bg-[rgb(255,30,90)]',
  secondary: 'bg-purple-500',
  text: 'text-white',
  accent: 'bg-[rgb(255,30,90)]',
};
        ...
        >
          <h2 className="text-4xl md:text-5xl font-extrabold mb-16 text-center tracking-tight">
            <span className="inline-block">
              <span className="relative inline-block">
                ...
                <span className="relative">Timeline Interactive</span>
              </span>
            </span>
          </h2>
          ...
          <div className="relative">
            ...
            <div
              ...
              style={{
                boxShadow: `0 0 15px rgb(255,30,90)`,
              }}
            ></div>
            ...
            {events.map((event, index) => {
              ...
              const eventColor = event.color 
                ? (event.color.startsWith('[') ? `bg-${event.color}` : `bg-${event.color}-500`)
                : primaryColor;
              ...
              return (
                ...
                >
                  ...
                  >
                    <motion.div
                      className={`w-10 h-10 rounded-full ${eventColor} flex items-center justify-center border-4 border-black cursor-pointer`}
                      ...
                      animate={{
                        boxShadow:
                          activeEvent === event.id
                            ? [
                                `0 0 0 rgba(255,30,90,0.5)`,
                                `0 0 20px rgba(255,30,90,0.8)`,
                                `0 0 0 rgba(255,30,90,0.5)`,
                              ]
                            : `0 0 0 rgba(255,30,90,0)`,
                      }}
                      transition={{
                  ...
                  {/* Content card */}
                  <motion.div
                    className={`relative z-10 bg-gray-900 bg-opacity-80 backdrop-blur-lg rounded-2xl overflow-hidden shadow-xl w-full md:w-[calc(100%-2rem)] ${
                  ...
                  >
                    ...
                    <div className="p-6">
                      <div className="flex items-center justify-between mb-4">
                        <span className={`text-sm font-mono text-[rgb(255,30,90)] tracking-wider`}>
                          {event.date}
                        </span>
