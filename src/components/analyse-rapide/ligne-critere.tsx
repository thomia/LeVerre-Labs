...
export function LigneCritere({ critere, notation, couleur, onChange }: LigneCritereProps) {
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center gap-2">
          ...
          {isMultiplicateur && (
            <span
              ...
              title="Ce curseur multiplie tout le score de l'élément : à 0, l'élément tombe à 0."
            >
              multiplicateur
            </span>
          )}
      ...
      <p className="mt-2 text-[10px] font-medium uppercase tracking-wide text-white/30">
        Ce que tu observes
      </p>
      ...
      {!isMultiplicateur && (
        <div className="mt-2 flex items-center justify-between gap-3 border-t border-white/5 pt-2">
          <span className="text-[10px] font-medium uppercase tracking-wide text-white/30">Poids</span>
          <SelecteurPoids
